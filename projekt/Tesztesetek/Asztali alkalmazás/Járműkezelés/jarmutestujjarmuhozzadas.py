...
try:
    ...
    for i in range(0, count-1, 1):
        ...
        if combo.selected_text() == "teszt":
            if jarmukezeles.child_window(auto_id="txbrendszam", control_type="Edit").get_value() == "teszt":
                print("Sikeresen Hozzáadva. Sikeres teszt.")
            else:
                print("Nem lett hozzáadva. Hiba mentés során.")
            if jarmukezeles.child_window(auto_id="txbtipus", control_type="Edit").get_value() == "teszt":
                print("Sikeresen Hozzáadva. Sikeres teszt.")
            else:
                print("Nem lett hozzáadva. Hiba mentés során.")
            if jarmukezeles.child_window(auto_id="txbtomeg", control_type="Edit").get_value() == "1111kg":
                print("Sikeresen Hozzáadva. Sikeres teszt.")
            else:
                print("Nem lett hozzáadva. Hiba mentés során.")
            if jarmukezeles.child_window(auto_id="txbmarka", control_type="Edit").get_value() == "teszt":
                print("Sikeresen Hozzáadva. Sikeres teszt.")
            else:
                print("Nem lett hozzáadva. Hiba mentés során.")
            if jarmukezeles.child_window(auto_id="txbtengely", control_type="Edit").get_value().strip() == "2222":
                print("Sikeresen Hozzáadva. Sikeres teszt.")
            else:
                value = jarmukezeles.child_window(auto_id="txbtengely", control_type="Edit").get_value()
                print(f"Tengely érték: '{value}', típus: {type(value)}")
                print("Nem lett hozzáadva. Hiba mentés során.")
            if jarmukezeles.child_window(auto_id="txbvin", control_type="Edit").get_value() == "TESZT":
                print("Sikeresen Hozzáadva. Sikeres teszt.")
            else:
                print("Nem lett hozzáadva. Hiba mentés során.")
    ...
    for i in range(0, count, 1):
        ...
        if combo.selected_text() == "teszt":
            ...
            print("Nem teszt érték nem törölhető!")
