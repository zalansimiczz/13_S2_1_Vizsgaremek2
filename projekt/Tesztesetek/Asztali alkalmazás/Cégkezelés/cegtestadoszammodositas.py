...
# CÉGKEZELÉS
fomenu.child_window(auto_id="btncegkezeles", control_type="Button").click()

try:
    cegkezeles = app.window(auto_id="cegkezeles")
    cegkezeles.wait("visible", timeout=5)

    textbox = cegkezeles.child_window(auto_id="txbcegszam", control_type="Edit")
    ...
    cegkezeles.child_window(auto_id="btnmentes", control_type="Button").click()

    time.sleep(1)


    cegkezeles.child_window(auto_id="btnvissza", control_type="Button").click()
    fomenu.child_window(auto_id="btncegkezeles", control_type="Button").click()
